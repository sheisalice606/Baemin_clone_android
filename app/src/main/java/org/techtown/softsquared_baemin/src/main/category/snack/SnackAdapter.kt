...
class SnackAdapter(val context: Context, private val items : ArrayList<SnackData>) :
    ...
    inner class Holder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val lowCost = this.itemView.findViewById<TextView>(R.id.fragment_snack_low_cost)
        // 최소 주문 비용
        val deliveryTime = this.itemView.findViewById<TextView>(R.id.fragment_snack_delivery_time)
