...
class NightAdapter(val context: Context, private val items : ArrayList<NightData>) :
    ...
    inner class Holder(itemView : View) : RecyclerView.ViewHolder(itemView) {
        ...
        // 평점
        val lowCost = itemView.findViewById<TextView>(R.id.fragment_night_low_cost)
        // 최소 주문 비용
        val deliveryTime = itemView.findViewById<TextView>(R.id.fragment_night_delivery_time)
        // 배달 시간
