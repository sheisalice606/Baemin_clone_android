...
class MyPageAdapterTop(val context : Context, private val items : ArrayList<MyPageDataTop>) :
        RecyclerView.Adapter<MyPageAdapterTop.Holder>() {
    ...
    inner class Holder(itemView : View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item : MyPageDataTop, context: Context) {
